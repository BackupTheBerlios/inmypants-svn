...
## PERSONALITY STUFF
# male or female
set IMPInfo(gender) "male"

# straight, gay, or bi
set IMPInfo(orientation) "straight"
...
# if you have more than one bot running imp, set one of them to 1 and all others to 0
...
set IMPInfo(randomChannels) { "#molsoft" }
...
set IMPSettings(typingSpeed) 0.05
