...
if {![IMP_plugin_check_depend "action_complex:hands"]} {
	return 0
}

IMP_plugin_add_action_complex "hands_dildo" "^sfkjhkjhdfkhdsf__¬$" 0 IMP_plugin_null "en"

#### DILDO (oh god :)
proc IMP_plugin_complex_action_hands_dildo { channel nick item item2 } {
  global IMPInfo mood
