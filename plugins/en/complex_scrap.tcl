...
proc IMP_plugin_complex_scrap { nick host handle channel text } {
...
# outputtype = 3 <-- silly adult output    
    ...
    IMPDoAction $channel "" $output
  }
}

IMP_plugin_add_complex "scrap" "^!scrap" 100 IMP_plugin_complex_scrap "en"
