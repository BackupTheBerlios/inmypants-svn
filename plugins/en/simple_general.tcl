...
IMP_plugin_add_simple "no-mirc" "mirc" 40 [list "mIRC < irssi" "use irssi" "mmm irssi" "irssi > *" "/fires %% into the sun"] "en"
IMP_plugin_add_simple "no-bitchx" "bitchx" 40 [list "bitchx < irssi" "use irssi" "mmm irssi" "irssi > *" "/fires %% into the sun"] "en"
IMP_plugin_add_simple "no-trillian" "trillian" 40 [list "trillian < irssi" "use trillian + bitlbee" "mmm irssi" "irssi > *" "/fires %% into the sun"] "en"
