...
proc IMP_plugin_complex_abbr { nick host handle channel text } {
  ...
  if [regexp -nocase "^!abbr( adult| xxx)?$" $text blah adult] {
    ...
    IMPDoAction $channel "" "$acronym: ${noun1}-${verb}-$noun2"
    return 1
  }
}

IMP_plugin_add_complex "abbr" "^!abbr" 100 IMP_plugin_complex_abbr "en"
