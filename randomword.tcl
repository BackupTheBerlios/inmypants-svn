...
proc pubm_beckyword {nick host handle channel text} {
  ...
  IMPDoAction $channel $nick "$prefix[pickRandom $randomFirstParts][pickRandom $randomMiddleParts][pickRandom $randomEndParts]"
}
...
proc pubm_kitword {nick host handle channel text} {
  ...
  IMPDoAction $channel $nick "[pickRandom $randomKitWords]"
}
